...
////    }
//
//    override suspend fun updateLocalDatabase(lessons: List<Lesson>) {
//        val updatedEntities = lessons.mapNotNull { lesson ->
//            lesson.createdAt?.let {
//                val localFavorite = lessonDao.getLessonByUid(lesson.uid).firstOrNull()?.isFavorite ?: false
//                LessonEntity(
//                    id = lesson.uid,
//                    userId = lesson.userId,
//                    content = lesson.content,
//                    updatedAt = it.time,
//                    isFavorite = localFavorite // On conserve la valeur locale
//                )
//            }
//        }
